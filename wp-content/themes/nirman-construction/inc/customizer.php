...
function nirman_construction_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('nirman_construction_theme_options',array(
        'default' => __('Right Sidebar','nirman-construction'),
...
final class Nirman_Construction_Customize {
		...
		$manager->add_section(
			new Nirman_Construction_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => esc_url( 'https://www.luzuk.com/themes/construction-wordpress-theme/' ),
				)
			)
		);
	}
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'nirman-construction-customize-controls', trailingslashit( get_template_directory_uri() ) . '/assets/js/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'nirman-construction-customize-controls', trailingslashit( get_template_directory_uri() ) . '/assets/css/customize-controls.css' );
	}
}
