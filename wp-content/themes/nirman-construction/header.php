				...
				<div class="row m-0">
					...
					<div class="col-lg-7 col-md-7 col-5 top-menu">
						<div class="toggle-menu responsive-menu">
				            <button onclick="nirman_construction_open()" role="tab"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','nirman-construction'); ?></span></button>
				        </div>
