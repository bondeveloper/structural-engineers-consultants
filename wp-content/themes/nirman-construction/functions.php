...
function nirman_construction_scripts() {
	...
	wp_enqueue_script( 'nirman-construction-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '1.0', true );

	$nirman_construction_l10n=array();
	
	if ( has_nav_menu( 'top' ) ) {
		wp_enqueue_script( 'nirman-construction-navigation-jquery', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '1.0', true );
		$nirman_construction_l10n['expand']         = __( 'Expand child menu', 'nirman-construction' );
		$nirman_construction_l10n['collapse']       = __( 'Collapse child menu', 'nirman-construction' );		
	}
	...
	wp_localize_script( 'nirman-construction-skip-link-focus-fix', 'nirman_constructionScreenReaderText', $nirman_construction_l10n );
...
//footer Link
define('NIRMAN_CONSTUCTION_LIVE_DEMO',__('https://luzuk.com/demo/nirman-construction/','nirman-construction'));
define('NIRMAN_CONSTUCTION_PRO_DOCS',__('http://luzuk.com/demo/nirman-construction/documentation/','nirman-construction'));
define('NIRMAN_CONSTUCTION_BUY_NOW',__('https://www.luzuk.com/themes/construction-wordpress-theme/','nirman-construction'));
