...
if ( ! function_exists( 'construc_comment_popup_link' ) ) {
	function construc_comment_popup_link() {
		comments_popup_link(
			__( '<span class="fa fa-comment"></span> No Comment', 'construc' ),
			__( '<span class="fa fa-comment"></span> 1 Comment', 'construc' ),
			__( '<span class="fa fa-comment"></span> % Comments', 'construc' ),
			'construc-comment',
			__( '<span class="fa fa-comment"></span> Comments are Closed', 'construc' )
		);
	}
}
