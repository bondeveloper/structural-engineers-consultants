    ...
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod('tameer_construction_slider_speed', 3000)); ?>"> 
                ...
                <?php if (get_theme_mod( 'tameer_construction_slider_button',true) != '' || get_theme_mod( 'tameer_construction_show_hide_slider_button',true) != ''){ ?>
                  <?php if( get_theme_mod('tameer_construction_slider_button_text','READ MORE') != ''){ ?>
                    <div class ="readbutton">
                      <a href="<?php esc_url(the_permalink()); ?>"><?php echo esc_html(get_theme_mod('tameer_construction_slider_button_text','READ MORE'));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('tameer_construction_slider_button_text','READ MORE'));?></span></a>
                    </div>
                  <?php } ?>
                <?php } ?>
              </div>
        ...
        <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
          ...
          <span class="screen-reader-text"><?php esc_attr_e( 'Previous','tameer-construction' );?></span>
        </a>
        <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-chevron-right"></i></span>
          <span class="screen-reader-text"><?php esc_attr_e( 'Next','tameer-construction' );?></span>
        </a>
      </div> 
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="about-text">
                  ...
                  <p><?php the_excerpt(); ?></p>
                  <div class ="aboutbtn">
                    <a href="<?php esc_url(the_permalink()); ?>"><?php esc_html_e('READ MORE','tameer-construction'); ?><span class="screen-reader-text"><?php esc_html_e( 'READ MORE','tameer-construction' );?></span></a>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
