  ...
  <section id="slider">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                ...
                <div class="more-btn">
                  <a href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e( 'READ MORE', 'industrial-lite' ); ?><span class="screen-reader-text"><?php esc_html_e( 'READ MORE','industrial-lite' );?></span></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
        ...
        <span class="screen-reader-text"><?php esc_attr_e( 'Previous','industrial-lite' );?></span>
      </a>
      <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
        <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-chevron-right"></i></span>
        <span class="screen-reader-text"><?php esc_attr_e( 'Next','industrial-lite' );?></span>
      </a>
    </div>
  </section>
