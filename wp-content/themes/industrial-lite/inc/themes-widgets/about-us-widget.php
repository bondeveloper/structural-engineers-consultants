...
class Industrial_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Industrial_Lite_About_Widget',
			__('VW About us', 'industrial-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'industrial-lite' ), ) 
		);
	}
	...
	public function form( $instance ) {
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','industrial-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','industrial-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','industrial-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','industrial-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','industrial-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','industrial-lite'); ?></label>
		<?php
...
function industrial_lite_about_custom_load_widget() {
	register_widget( 'Industrial_Lite_About_Widget' );
}
add_action( 'widgets_init', 'industrial_lite_about_custom_load_widget' );