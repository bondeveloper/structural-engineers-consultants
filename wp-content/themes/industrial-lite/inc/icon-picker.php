...
class Industrial_Lite_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $industrial_lite_font_awesome_icon_array = industrial_lite_font_awesome_icon_array();
                    foreach ($industrial_lite_font_awesome_icon_array as $industrial_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $industrial_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($industrial_lite_font_awesome_icon).'"></i>
                            <span class="industrial-lite-social-class">'.esc_attr($industrial_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function industrial_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'industrial-lite-customizer-script', get_template_directory_uri().'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'industrial_lite_customizer_script' );

if(!function_exists('industrial_lite_font_awesome_icon_array')){
    function industrial_lite_font_awesome_icon_array(){
