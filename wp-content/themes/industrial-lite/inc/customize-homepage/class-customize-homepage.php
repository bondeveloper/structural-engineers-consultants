...
if ( ! class_exists( 'Industrial_Lite_Content_Creation' ) ) :

	/**
	 * Industrial_Lite_Content_Creation class.
	 */
	class Industrial_Lite_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * Industrial_Lite_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Industrial_Lite_Content_Creation' );
