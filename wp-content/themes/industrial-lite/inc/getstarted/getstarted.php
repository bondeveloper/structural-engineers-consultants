...
function industrial_lite_admin_theme_style() {
   ...
   wp_enqueue_style('industrial-lite-custom-admin-style', get_template_directory_uri() . '/inc/getstarted/getstarted.css');
   wp_enqueue_script('industrial-lite-tabs', get_template_directory_uri() . '/inc/getstarted/js/tab.js');
}
    ...
    <div class="tab-sec">
		...
		<div id="lite_theme" class="tabcontent open">
				...
				<div class="info-link">
		  		...
		  		<div class="link-customizer">
					...
					<div class="first-row">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=industrial_lite_left_right') ); ?>" target="_blank"><?php esc_html_e('Blog Layout','industrial-lite'); ?></a>
							</div>
							<div class="row-box2">
			...
			<div class="col-right-inner">
                ...
                <ul>
                	<li><?php esc_html_e('1. Create a Page to set template:  Go to ','industrial-lite'); ?>
                  	<b><?php esc_html_e('Dashboard &gt;&gt; Pages &gt;&gt; Add New Page','industrial-lite'); ?></b>.
                  	<p><?php esc_html_e('Label it "home" or anything as you wish. Then select template "home-page" from template dropdown.','industrial-lite'); ?></p></li>
                  	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstarted/images/home-page-template.png" alt="" />
                  	<p></p><span class="strong"><?php esc_html_e('2. Set the front page:','industrial-lite'); ?></span><?php esc_html_e(' Go to ','industrial-lite'); ?>
				  	<b><?php esc_html_e(' Settings -&gt; Reading --&gt; Set the front page display static page to home page ','industrial-lite'); ?></b></p>
                  	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstarted/images/set-front-page.png" alt="" />
                  	<p><?php esc_html_e(' Once you are done with this, you can see all the demo content on front page. ','industrial-lite'); ?></p>
                </ul>
		  	</div>
		</div>	
