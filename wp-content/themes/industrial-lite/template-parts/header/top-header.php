...
<div class="container">
	<div class="main-header-box">
		      		...
		      		<div class="row">
				        ...
				        <div class="col-lg-1 col-md-2 col-3">
				          	<div class="search-box">
				            	<a href="#" onclick="industrial_lite_search_open()"><span><i class="fas fa-search"></i></span></a>
				          	</div>
				        </div>
				      	<?php }?>
		...
		<div class="serach_outer">
          	...
          	<a href="#main" onclick="industrial_lite_search_close()" class="closepop"><i class="fa fa-window-close"></i></a>
        </div>
	</div>
</div>