    ...
    <div class="single-post">
        ...
        <?php if( get_theme_mod( 'industrial_lite_toggle_postdate',true) != '' || get_theme_mod( 'industrial_lite_toggle_author',true) != '' || get_theme_mod( 'industrial_lite_toggle_comments',true) != '') { ?>
            <div class="post-info">
                ...
                <?php if(get_theme_mod('industrial_lite_toggle_comments',true)==1){ ?>
                    <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'industrial-lite'), __('0 Comments', 'industrial-lite'), __('% Comments', 'industrial-lite') ); ?> </span>
                <?php } ?>
            </div>
        <?php } ?>
        ...
        <?php
            ...
            if ( is_singular( 'attachment' ) ) {
                ...
                the_post_navigation( array(
                    'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'industrial-lite' ) . '</span> ' .
                        '<span class="screen-reader-text">' . __( 'Next post:', 'industrial-lite' ) . '</span> ' .
                        '<span class="post-title">%title</span>',
                    'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'industrial-lite' ) . '</span> ' .
