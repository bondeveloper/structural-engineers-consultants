  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
    <?php $construction_hub_slide_pages = array();
      for ( $count = 1; $count <= 4; $count++ ) {
        $mod = intval( get_theme_mod( 'construction_hub_slider_page' . $count ));
        if ( 'page-none-selected' != $mod ) {
          $construction_hub_slide_pages[] = $mod;
        }
      }
        ...
        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
          ...
          <div class="carousel-caption">
            <div class="inner_carousel">
              <h2><?php the_title(); ?></h2>
              <p><?php $excerpt = get_the_excerpt();echo esc_html( construction_hub_string_limit_words( $excerpt,20 ) ); ?></p>
              <div class="more-btn">              
