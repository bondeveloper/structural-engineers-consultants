...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <div class="page-box row">
    ...
    <div class="box-content">
      ...
      <p><?php $excerpt = get_the_excerpt(); echo esc_html( construction_hub_string_limit_words( $excerpt, esc_attr(get_theme_mod('construction_hub_excerpt_count','35')))); ?></p>
      <?php if(get_theme_mod('construction_hub_remove_read_button',true) != ''){ ?>
        <div class="readmore-btn">
          <a href="<?php echo esc_url( get_permalink() );?>" class="blogbutton-small" title="<?php esc_attr_e( 'Read More', 'construction-hub' ); ?>"><?php echo esc_html(get_theme_mod('construction_hub_read_more_text','Read More','construction-hub'));?></a>
        </div>
      <?php }?>
    </div>
