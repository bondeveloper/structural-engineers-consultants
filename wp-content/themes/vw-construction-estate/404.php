...
<main id="maincontent" role="main" class="content-vw">
	<div class="container">
        <div class="page-content">
				...
				<?php if( get_theme_mod( 'vw_construction_estate_404_page_button_text',true) != '') { ?>
					<div class="read-moresec">
	            		<a href="<?php echo esc_url( home_url() ) ?>" class="button"><?php echo esc_html(get_theme_mod('vw_construction_estate_404_page_button_text',__('Return to Home Page','vw-construction-estate')));?><span class="screen-reader-text"><?php esc_html_e( 'Return to Home Page','vw-construction-estate' );?></span></a>
					</div>
				<?php }?>
