...
<main id="maincontent" role="main">
	...
	<?php if( get_theme_mod('vw_construction_estate_slider_hide_show',true) != ''){ ?>
	  	<section class="slider">
		    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
		          ...
		          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
		            ...
		            <div class="carousel-caption">
		              <div class="inner_carousel">
		                ...
		                <div class="more-btn">              
		                  <a href="<?php the_permalink(); ?>"><?php esc_html_e('DISCOVER MORE','vw-construction-estate'); ?><span class="screen-reader-text"><?php esc_html_e( 'DISCOVER MORE','vw-construction-estate' );?></span></a>
		                </div>
		              </div>
		            </div>
		          </div>
		      ...
		      <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
		        ...
		        <span class="screen-reader-text"><?php esc_attr_e( 'Previous','vw-construction-estate' );?></span>
		      </a>
		      <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
		        <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-angle-right"></i></span>
		        <span class="screen-reader-text"><?php esc_attr_e( 'Next','vw-construction-estate' );?></span>
		      </a>
		    </div>  
		        	...
		        	<div class="row">
			        	<div class="abt-image col-lg-4 col-md-4">
			          	...
			          	<div class="col-lg-8 col-md-8 content-sec">
			            	...
			            	<div class ="about-btn">
			              		<a href="<?php echo esc_url( the_permalink() ); ?>"><span><?php echo esc_html(get_theme_mod('vw_construction_estate_about_name',__('DISCOVER MORE','vw-construction-estate'))); ?></span><span class="screen-reader-text"><?php esc_html_e( 'DISCOVER MORE','vw-construction-estate' );?></span></a>
			            	</div>
			          	</div>  
		          	</div>        	
		        <?php endwhile; 
