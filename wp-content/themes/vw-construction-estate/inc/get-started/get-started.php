...
function vw_construction_estate_admin_theme_style() {
   ...
   wp_enqueue_style('vw-construction-estate-custom-admin-style', get_template_directory_uri() . '/inc/get-started/get-started.css');
   wp_enqueue_script('vw-construction-estate-tabs', get_template_directory_uri() . '/inc/get-started/js/tab.js');
}
