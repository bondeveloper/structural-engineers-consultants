...
function vw_construction_estate_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_construction_estate_loader_icon',array(
        'default' => __('Two Way','vw-construction-estate'),
        'sanitize_callback' => 'vw_construction_estate_sanitize_choices'
	));
    ...
    //Selective Refresh
    $wp_customize->selective_refresh->add_partial('vw_construction_estate_location', array('selector' => 'p.diff-lay', 
    ...
    $wp_customize->selective_refresh->add_partial(
        'vw_construction_estate_slider_hide_show',array(
	...
	//Selective Refresh
    $wp_customize->selective_refresh->add_partial(
        'vw_construction_estate_toggle_postdate', array( 
    ...
    $wp_customize->add_setting('vw_construction_estate_excerpt_settings',array(
        'default' => __('Excerpt','vw-construction-estate'),
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_construction_estate_sanitize_choices'
    ));
	...
	//Selective Refresh
    $wp_customize->selective_refresh->add_partial(
        'vw_construction_estate_footer_copy', array( 
	...
	$wp_customize->add_setting('vw_construction_estate_copyright_alingment',array(
        'default' => __('center','vw-construction-estate'),
        'sanitize_callback' => 'vw_construction_estate_sanitize_choices'
	));
    ...
    //Selective Refresh
    $wp_customize->selective_refresh->add_partial(
        'vw_construction_estate_scroll_top_icon', array( 
            'selector' => '.scrollup i', 
...
final class VW_Construction_Estate_Customize {
	...
	public function sections( $manager ) {
		...
		// Register sections.
		$manager->add_section(new VW_Construction_Estate_Customize_Section_Pro($manager,'example_1',array(
			'priority'   => 1,
		...
		// Register sections.
		$manager->add_section(new VW_Construction_Estate_Customize_Section_Pro($manager,'example_2',array(
			'priority'   => 1,
