...
class VW_Construction_Estate_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Construction_Estate_About_Widget',
			__('VW About us', 'vw-construction-estate'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-construction-estate' ), ) 
		);
	}
	...
	public function form( $instance ) {
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-construction-estate'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-construction-estate'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-construction-estate'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-construction-estate'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-construction-estate'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-construction-estate'); ?></label>
		<?php
...
function vw_construction_estate_about_custom_load_widget() {
	register_widget( 'VW_Construction_Estate_About_Widget' );
}
add_action( 'widgets_init', 'vw_construction_estate_about_custom_load_widget' );