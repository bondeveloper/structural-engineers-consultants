...
<header role="banner">
  ...
  <div id="header">
    <?php if( get_theme_mod('vw_construction_estate_topbar_hide_show',true) != ''){ ?>
      <div class="row m-0">
    ...
    <?php } ?>
    <div class="header-menu <?php if( get_theme_mod( 'vw_construction_estate_sticky_header') != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
      <div class="row m-0">
        <div class=" col-lg-3 col-md-3">
          <div class="logo">
            ...
            <div class="<?php echo esc_html( $colmd ); ?>">
              <div class="menu">
                 <div class="toggle-nav mobile-menu">
                  <button onclick="vw_construction_estate_menu_open_nav()"><i class="<?php echo esc_attr(get_theme_mod('vw_construction_estate_res_open_menu_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','vw-construction-estate'); ?></span></button>
                </div>
...
<?php if(get_theme_mod('vw_construction_estate_loader_enable',true)==1){ ?>
  <div id="preloader">
    <div id="status">
      <?php $theme_lay = get_theme_mod( 'vw_construction_estate_loader_icon','Two Way');
