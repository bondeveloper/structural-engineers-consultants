	...
	class WooVina_Sites_Demos {
		...
		public static function get_demos_data() {
			...
			$data = array(
				...
				'Faster' => array(
					'categories'        => array('Clothing Fashion', 'Electronics', 'Furniture'),
				...
				'Afela' => array(
					'categories'        => array('Clothing Fashion'),
					'demo_class'        => 'free-demo',
				...
				'Genius' => array(
					'categories'        => array('Furniture', 'Electronics', 'Clothing Fashion'),
					'demo_class'        => 'free-demo',
				...
				'Pomer' => array(
					'categories'        => array('Health Beauty', 'Jewelry Accessories'),
					'demo_class'        => 'free-demo',
				...
				'Alice Mart' => array(
					'categories'        => array('Electronics', 'Clothing Fashion', 'Furniture'),
					'demo_class'        => 'free-demo',
				...
				'Sport' => array(
					'categories'        => array('Clothing Fashion', 'Sports Recreation'),
					'demo_class'        => 'free-demo',
				...
				'Wedens' => array(
					'categories'        => array('Jewelry Accessories'),
					'demo_class'        => 'free-demo',
				...
				'Ekko Center' => array(
					'categories'        => array('Toys Games', 'Electronics'),
					'demo_class'        => 'free-demo',
				...
				'Pet Food' => array(
					'categories'        => array('Food Drink', 'Other'),
					'demo_class'        => 'free-demo',
